...
- If the question is written in English, your entire answer must be in English.
  Translate any Arabic legal text from the source documents into clear English.
  Do not copy Arabic sentences into an English answer.
- If the question is written in Arabic, your entire answer must be in Arabic.
- Never mix English and Arabic within the same answer.
